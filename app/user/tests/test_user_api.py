...
class PublicUserApiTest(TestCase):
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@testtest.com', 'password': 'Pass123'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@test@gmail.com', password='Pass123')
        payload = {'email': 'test@test@gmail.com', 'password': 'WrongPass'}
        res = self.client.post(TOKEN_URL, payload)
